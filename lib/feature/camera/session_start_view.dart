import 'package:be_my_voice/feature/camera/session_start_countdown.dart';
...
class SessionStartView extends StatefulWidget {
  createState() {
    return SessionStartViewState();
  }
}

class SessionStartViewState extends State<SessionStartView> {
  @override
  void initState() {
    super.initState();
    Future.delayed(Duration(seconds: 3), () {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SessionStartCountdown()),
      );
    });
  }
